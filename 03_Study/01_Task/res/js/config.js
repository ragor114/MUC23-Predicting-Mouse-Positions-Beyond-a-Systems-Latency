...
const Config = {
    ...
    targetWidths: [34, 45, 57, 68, 79, 90, 102], //[34, 45, 57, 68, 79, 90, 102],// [23, 34, 45, 57, 68, 79, 90, 102],
    ...
    currentModel: curr,
                        // Dense, RNN, Transformer, Optimized, Ensemble
    ...
    possibleBuffers: [0, 2, 3, 4, 6], //[0, 3, 6],
};
