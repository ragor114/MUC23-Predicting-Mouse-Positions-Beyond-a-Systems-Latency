...
class MouseLogger {
    ...
    onMouseMove(timestamp, active, x, y, xPosTarget, xPosStart, targetLength, targetWidth, distanceToTopBorder, distanceToBottomBorder) {
        let aI = 0;
        if(active) aI = 1;
        // console.log(targetWidth);
        this.#logList.push([timestamp, aI, x, y, xPosTarget, xPosStart, targetLength, targetWidth, distanceToTopBorder, distanceToBottomBorder]);
        this.#currLogs.push([timestamp, aI, x, y, xPosTarget, xPosStart, targetLength, targetWidth, distanceToTopBorder, distanceToBottomBorder]);
    }
