...
// TODO: integrate other architectures - RNN done, Transformer missing
// TODO: Clean up code
...
function logMousePosition() {
    ...
    if(target !== null && target !== undefined) {
        ...
        distanceToTop = mousePos.displayY - (canvas.height/2 - targetWidth/2);
        distanceToBottom = (canvas.height/2 + targetWidth/2) - mousePos.displayY;
    } else {
        tLength = -1;
        targetWidth = -1;
        targetXPos = -1;
    ...
    mouseLogger.onMouseMove(Date.now(), active, mousePos.displayX, mousePos.displayY, targetXPos, startXPos, tLength, targetWidth, distanceToTop, distanceToBottom);
